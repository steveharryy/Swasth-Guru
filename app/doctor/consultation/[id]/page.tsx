...
export default function DoctorConsultationPage() {
  ...
  useEffect(() => {
    ...
    const currentApt = storedAppointments.find((apt: any) => apt.id === appointmentId);
    ...
    if (status !== 'ready') {
      return; // Stop initialization if not ready
    }
              ...
              <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-4 p-2 bg-black/40 backdrop-blur-xl rounded-2xl border border-white/10 opacity-0 group-hover:opacity-100 transition-all">
                {!isCallActive ? (
                  <Button
                    ...
                    className="h-11 px-8 text-lg font-bold rounded-xl bg-primary text-white shadow-xl hover:scale-105 transition-all"
                  >
            ...
            <Card className="border shadow-none rounded-2xl p-6 bg-card">
              ...
              <CardContent className="px-0 pb-0 space-y-4">
                ...
                <Button
                  ...
                  className="h-10 px-6 text-sm font-bold rounded-xl bg-primary text-white shadow-sm hover:scale-[1.02] active:scale-95 transition-all"
                >
              ...
              <CardContent className="px-0 pb-0 space-y-4">
                ...
                <div className="flex flex-col gap-3">
                  <Button
                    ...
                    className="h-11 text-sm font-bold rounded-xl bg-primary text-white shadow-xl hover:scale-[1.02] active:scale-95 transition-all"
                  >
