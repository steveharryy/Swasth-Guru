                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-muted rounded-xl border">
                    <div className="flex items-center gap-3">
                      ...
                      <p className="text-sm font-bold text-foreground">{new Date(appointment.date).toLocaleDateString()}</p>
                    </div>
                    <div className="flex items-center gap-3">
                  ...
                  <div className="p-4 border-t bg-muted/20">
                    <div className="flex gap-2">
                      ...
                      <Button
                        ...
                        className="h-10 w-10 rounded-xl bg-primary text-white shadow-lg shadow-primary/20 hover:scale-105 transition-all"
                      >
