        ...
        const fetchAppointment = async () => {
            ...
            if (!currentApt) {
                try {
                    ...
                    // We don't have a direct GET /appointments/:id but we can search for it
                    // Or we could implement /api/appointments/:id
                    const res = await fetch(`${apiUrl}/appointments/${roomId}`); // I'll add this route
                    if (res.ok) {
